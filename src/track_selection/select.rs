...
fn track_info(
    ...
    TrackInfo {
        ...
        min_bandwidth_bps: adaptation_set.minBandwidth,
        max_bandwidth_bps: adaptation_set.maxBandwidth,
        min_width: adaptation_set.minWidth,
        max_width: adaptation_set.maxWidth,
        min_height: adaptation_set.minHeight,
        max_height: adaptation_set.maxHeight,
        min_frame_rate: adaptation_set.minFrameRate.clone(),
        max_frame_rate: adaptation_set.maxFrameRate.clone(),
        sub_tracks,
        accessibility,
